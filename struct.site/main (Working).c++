...
//#include "MPI.h"
//#include <noware/cluster/cluster.h>
//#include "Memory.h"
//#include "HPC.cpp"
...
/*
	...
	//noware::cluster::processor cpu (false);
	std::string error;

	//cpu.enqueue ("test.txt");
	std::queue <noware::cluster::processor::instructions> instrs;
...
*/
	...
	else
	{
		...
		if (cl.enqueue (argc > 1 ? argv [1] : "Instructions.TXT"))
		{
			...
			cl.processor_.memory_.network_device = argc > 2 ? (int) (noware::variable) (argv [2]) : 0;
			cl.processor_.memory_.refresh_local_address ();
			
			cl.processor_.run (true);
		}
		else
		{
...
*/
	...
	_memory.mpi_.tcp_port (7);	//12
	_memory.mpi_.udp_port (6);	//13
...
//			memory.~Memory ();
		...
		else if (option == 5)
		{
			...
			cout << mmpi.listen () << endl;
		}
		else if (option == 6)
		{
			cout << "Received Message: ";
			cout << mmpi.receive () << endl;
		}
		else if (option == 7)
		{
