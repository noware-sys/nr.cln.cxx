...
//static const unsigned short int LIB::communication::messaging::default_udp_port;
//static const unsigned short int LIB::communication::messaging::default_tcp_port;
const unsigned short int LIB::communication::messaging::default_udp_port = 4;
const unsigned short int LIB::communication::messaging::default_tcp_port = 5;
