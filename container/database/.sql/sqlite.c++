...
*/
const bool LIB::container::database::sql::sqlite::operator == (const LIB::container::database::sql::sqlite & other) const
{
	return this == &other;
}

const bool LIB::container::database::sql::sqlite::query (LIB::container::NAME_A <LIB::container::NAME_A <LIB::container::NAME_V, LIB::container::NAME_V>, LIB::container::NAME_V> & result, const std::string & qry, const LIB::container::NAME_A <LIB::container::NAME_V, LIB::container::NAME_V> & arguments, const LIB::mathematics::numbers::natural & tries_max)
{
	if (! connected ())
		return false;
	...
	//va_start (argv, count);
	//
	//val = va_arg (argv, LIB::container::NAME_V);
	//
	//va_end (argv);
...
const bool LIB::container::database::sql::sqlite::query (LIB::container::NAME_A <LIB::container::NAME_A <LIB::container::NAME_V, LIB::container::NAME_V>, LIB::container::NAME_V> & result, const std::string & qry, const LIB::mathematics::numbers::natural & tries_max)
{
	const LIB::container::NAME_A <LIB::container::NAME_V, LIB::container::NAME_V> arguments;
	
	return query (result, qry, arguments, tries_max);
}

const bool LIB::container::database::sql::sqlite::query (const std::string & qry, const LIB::container::NAME_A <LIB::container::NAME_V, LIB::container::NAME_V> & arguments, const LIB::mathematics::numbers::natural & tries_max)
{
