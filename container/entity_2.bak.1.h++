...
namespace LIB
{
	namespace containers
	{
		class entity_2
		{
			...
			protected:
				initialize (const LIB::databases::sqlite *& = NULL, const LIB::memory::key &/* current_group*/ = default_group, const LIB::memory::key &/* previous_group*/ = default_previous_group, const LIB::memory::key &/* previous_name*/ = default_name, const std::string &/* _database_name*/ = default_database_name);
				initialize (const std::string &/* _database_name*/);

				// The container.
				LIB::databasess::sqlite * db;
