...
bool LIB::cluster::machine::enqueue (const std::string & file_name)
{
...
std::string LIB::cluster::machine::get_error_code (void)
{
	return (std::string) (error [(std::string) "code"]);
}

std::string LIB::cluster::machine::get_error_message (void)
{
