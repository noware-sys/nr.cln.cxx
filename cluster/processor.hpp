	...
	namespace cluster
	{
		class processor
		{
				...
				class instructions
				{
					...
					public:
						...
						*/
						...
						std::queue <LIB::cluster::processor::instruction> _instructions;
						////std::string inputs [2];
						////LIB::NAME_V output;
						//std::string output;
						//operation _operation;
			...
			protected:
				...
				void perform (void);
				void _do (LIB::cluster::processor::instruction);
				void pause (void);
			...
			public:
				LIB::cluster::processor::instruction pop (void);
