...
namespace LIB
{
	namespace cluster
	{
		class entity : virtual protected LIB::containers::entity_2
		//class entity : virtual public LIB::containers::entity_2
		{
			public:
				/*
		...
		//		entity operator [] (const LIB::containers::memory::key &/* name*/);
			...
			//	static const LIB::containers::memory::value backup;
				...
				static LIB::containers::NAME_A <LIB::mathematics::numbers::natural, LIB::machine::resources::memory *> instances;
