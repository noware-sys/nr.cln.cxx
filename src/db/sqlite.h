...
/*
	Define the following to a true boolean value
	to allow externally setting the affected rows
	by using the function "sqlite3_changes_set".
	
	A false value or non definition will not enable the function.
*/
#ifndef SQLITE_CHANGES_SET
	#define SQLITE_CHANGES_SET 1
#endif
...
SQLITE_API int SQLITE_STDCALL sqlite3_changes(sqlite3*);
	...
	SQLITE_API void SQLITE_STDCALL sqlite3_changes_set (sqlite3 *, int);
#endif
