class manager : public device
{
	public:
		...
		const noware::number sequence_group_min (void) const;
		const noware::number sequence_key_min (const std::string &/* group*/) const;
		
		const noware::number sequence_group_max (void) const;
		const noware::number sequence_key_max (const std::string &/* group*/) const;
		
		const noware::number sequence_group_next_available (void) const;
		const noware::number sequence_key_next_available (const std::string &/* group*/) const;
