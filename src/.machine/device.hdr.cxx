	...
	//{
			class device //: misc::instance
			{
				public:
					...
					virtual const noware::var/* response*/ multicast (const noware::tree <> &/* message*/, const std::string &/* (zyre) group*/ = /*noware::machine::device::*/group_default, const std::string &/* filter*/ = "");
				...
				//protected:
					...
					virtual const noware::var/* result*/ aggregate (const noware::var &/* result*/, const noware::var &/* response*/, const noware::tree <> &/* expression*/);
				//private:
					...
					virtual const noware::var receive_local (const std::string &/* (zyre) group (to receive from (where the message was sent to))*/ = /*noware::machine::device::*/group_default, const std::string &/* ^filter*/ = "") const;
