...
template <typename value, typename key>
noware::array <_value, _key>::zyre <value, key>::zyre (void)
{
	init ();
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::fin (void)
{
	return true;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::inited (void) const
{
	return true;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::init (void)
{
	return true;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const noware::nr noware::array <_value, _key>::zyre <value, key>::size (void) const
{
	return 0;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::exist (const key & group, const key & k) const
{
	return false;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::exist (const key & k) const
{
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::full (void) const
{
	return false;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::empty (void) const
{
	return size () <= 0;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const value & noware::array <_value, _key>::zyre <value, key>::get (const noware::var & group, const key & k)
{
	value tmp;
	return tmp;
}
...
template <typename _value, typename _key>
template <typename value, typename key>
const value & noware::array <_value, _key>::zyre <value, key>::get (const key & k)
{
...
template <typename _value, typename _key>
template <typename value, typename key>
const bool noware::array <_value, _key>::zyre <value, key>::set (const key & group, const key & k, const value & val)
{
	std::string _owner;
	
	if (exist (group, k, _owner))
	{
		noware::tree <key> message;
