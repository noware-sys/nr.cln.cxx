...
*/
	...
	class sqlite //: protected db::sqlite
	{
		...
		public:
			...
			static const std::string query_sql_initial_entity_group_avail_seq;
			static const std::string query_sql_initial_entity_key_avail_seq;
			static const std::string query_sql_initial_entity_group_next_seq;
			static const std::string query_sql_initial_entity_key_next_seq;
