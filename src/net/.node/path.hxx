...
*/			class path
			{
				public:
					...
					const LIB::math::numbers::natural size (const std::string &/* endpoint*/) const;
					const bool add (const std::string &/* endpoint*/, const LIB::math::numbers::natural &/* latency*/);
					//const std::string optimum (void) const;
					const std::string average (void) const;
					const std::string minimum (void) const;
					
					//const LIB::container::NAME_A <LIB::container::NAME_A <std::string, std::string>, LIB::math::numbers::natural> all (void) const;
					const LIB::container::NAME_A <LIB::container::NAME_A <LIB::container::any, LIB::container::any>, LIB::container::any> all (void) const;
					
					// Limits
					static const bool default_journal_limit_maximum;
					static const unsigned short int/*LIB::math::numbers::natural*/ default_journal_maximum;
					
					bool journal_limit_maximum;
					// This designates the maximum entries per endpoint.
					LIB::math::numbers::natural journal_maximum;
				protected:
					LIB::container::db::sql::sqlite db;
