...
const boost::asio::ip::address noware::net::ip::network (const boost::asio::ip::address & address, const boost::asio::ip::address & mask)
{
	if (address.is_v4 () && mask.is_v4 ())
	{
		...
		//return boost::asio::ip::address (noware::tools::string (net & 0xFF) + '.' + noware::tools::string (net >> 8 & 0xFF) + '.' + noware::tools::string (net >> 16 & 0xFF) + '.' + noware::tools::string (net >> 24 & 0xFF));
...
//const noware::container::array <noware::net::ip::address, noware::math::numbers::natural> noware::net::ip::addresses (const noware::math::numbers::natural & device, const bool & loopback_include)
//const noware::container::array <boost::asio::ip::address, noware::math::numbers::natural> noware::net::ip::addresses (const noware::math::numbers::natural & device, const bool & loopback_include)
const noware::container::array <noware::container::array <noware::container::array <std::string, std::string>, noware::math::numbers::natural>, std::string> noware::net::ip::addresses (/*const noware::math::numbers::natural & device, const bool & loopback_include*/void)
{
	//noware::math::numbers::natural i;
	//address address_test;
	boost::asio::ip::address _address;
	//noware::container::array <address, noware::math::numbers::natural> addresses_;
	//noware::container::array <boost::asio::ip::address, noware::math::numbers::natural> _addresses;
	noware::container::array <noware::container::array <noware::container::array <std::string, std::string>, noware::math::numbers::natural>, std::string> _addresses;
	noware::math::numbers::natural version;
...
//std::string noware::Network::IP::v4::Address (void)
//{
//	return "";
//}
//
//std::string noware::Network::IP::v6::Address (void)
//{
//	return "";
//}
...
//noware::net::ip::connection::connection (void)
//{
//	proto = protocol::tcp;
//}

//std::ostream & /*noware::container::array <value, key>::*/operator << (std::ostream & stream, const noware::net::ip::address & address/*, const std::string & indentation*/)
//{
//	return stream << address.to_string ();
//}

const noware::container::array <std::string, noware::math::numbers::natural> noware::net::ip::networks (void)
{
	noware::container::array <std::string, noware::math::numbers::natural> nets;
	
	for (const noware::container::array <noware::container::array <noware::container::array <std::string, std::string>, noware::math::numbers::natural>, std::string>::container & interface : addresses ())
	{
		for (const noware::container::array <noware::container::array <std::string, std::string>, noware::math::numbers::natural>::container & version : interface.v)
		{
			//for (const noware::container::array <std::string, std::string>::container & attributes : version.v)
			//{
