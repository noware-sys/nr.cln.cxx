class allocator : public device
{
	public:
		...
		const noware::nr key_min (const std::string &/* group*/ = noware::container::list::sqlite::group_default) const;
		const noware::nr key_max (const std::string &/* group*/ = noware::container::list::sqlite::group_default) const;
		const noware::nr key_next (const std::string &/* group*/ = noware::container::list::sqlite::group_default) const;
		const noware::nr key_avail (const std::string &/* group*/ = noware::container::list::sqlite::group_default) const;
