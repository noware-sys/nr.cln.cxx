...
*/
/*
const bool noware::nr::operator == (const cln::cl_N & other)
{
	return content == other;
}
*/
/*
const bool noware::nr::operator = (const cln::cl_R & other)
{
	return content == other;
}
*/
...
/*
const bool noware::nr::operator == (const cln::cl_F & other)
{
	return content == other;
}
*/
