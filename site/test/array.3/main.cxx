...
int main (int argc, char * argv [])
{
	...
	std::string selection, key, value;
	noware::array <std::string, int> dam;	// Direct Access Memory.
	...
	do
	{
		...
		else if (selection == "1")
		{
			...
			std::cout << "  " << "Exist : [" << key << "] == " << (dam.exist (key) ? "True" : "False") << std::endl;
		}
		else if (selection == "2")
		{
			std::cout << "  " << "Key: ";
			...
			if (dam.get (key, value))
			{
				std::cout << "    " << '[' << key << ']' << " == " << '[' << value << ']' << std::endl;
			}
			else
			{
				std::cout << "    " << "Failure/Does not exist" << std::endl;
			}
		}
		else if (selection == "3")
		{
			...
			std::cout << "  " << "Setting : [" << key << "] = [" << value << "] ... " << (dam.set (key, value) ? "Success" : "Failure") << std::endl;
		}
		else if (selection == 4)
		{
			std::cout << "  " << "Key: ";
			...
			std::cout << "  " << "Removing : " << '[' << key << "] ... " << (dam.remove (key) ? "Success" : "Failure") << std::endl;
		}
		else if (selection == 5)
		{
