...
int main (int argc, char * argv [])
{
	...
	{
		std::cout << std::endl;
		std::cout << "Obtainment of Content of File:" << std::endl;
		std::cout << std::endl;
		...
		else if (selection == 2)
		{
			...
			std::cout << "  " << "Setting content to file [" << path << "] : [" << noware::tool::file::content::get (path, content) << ']' << std::endl;
		}
		else //if (selection != 0)
		{
