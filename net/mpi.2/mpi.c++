...
const bool LIB::network::mpi::receive_async (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> & handler, LIB::container::NTT <> & address, const bool & cycle)
{
	...
	boost::hash_combine <const boost::function <void (const LIB::container::NTT <> &, const std::string &)> &> (hash, handler);
...
const bool LIB::network::mpi::receive_async_stop (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> & handler)
{
	return receive_async_stop (handler, reception.reliable);
}

const bool LIB::network::mpi::receive_async_stop (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> & handler, const LIB::container::NTT <> & address)
{
	//if (handler != NULL)
	//{
		unsigned long int hash = 0;
...
const bool LIB::network::mpi::listen_async_stop (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> & handler)
{
	return listen_async_stop (handler, reception.unreliable);
}

const bool LIB::network::mpi::listen_async_stop (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> & handler, const LIB::container::NTT <> & address)
{
	unsigned long int hash = 0;
