			...
			class cluster
			{
				...
				*/
				...
				protected:
					...
					//boost::function <void (const LIB::container::object <> &/* remote_endpoint*/, const std::string &/* message*/)> * handler;
					boost::function <void (const LIB::container::object <> &/* remote_endpoint*/, const LIB::container::object <> &/* message*/)> * handler;
...
//					void act_broadcast_discovery (std::string /*Received message.*/);
				...
				public:
					const bool transmit (const noware::container::object <> &, const LIB::math::numbers::natural &/* id*/) const;
					const std::string communicate (const noware::container::object <> &, const LIB::math::numbers::natural &/* id*/) const;
					//const bool broadcast (const noware::container::object <> &) const;
					const bool broadcast (noware::container::object <>) const;
					const std::string communicate_mass (const noware::container::object <> &) const;
					...
					*/
					...
					const bool receive_async (const boost::function <void (const noware::container::object <> &/* message*/, const LIB::container::object <> &/* remote_endpoint*/)> & /* handler*/);
