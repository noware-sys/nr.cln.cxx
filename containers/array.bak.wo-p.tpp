...
template <typename value, typename key>
/*value &*/ bool LIB::NAME_A <value, key>::/*operator []*/ enqueue/*append*/ (const value & _value_, key & _key_)
{
	/*
	switch (typeid (key))
	{
...
template <typename value, typename key>
bool LIB::NAME_A <value, key>::set (const key & _key, const value & value_)
{
	value temp;
