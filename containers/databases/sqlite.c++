...
//static const unsigned short int LIB::containers::databases::sqlite::default_tries;
const LIB::mathematics::numbers::natural LIB::containers::databases::sqlite::default_tries = 3;


LIB::containers::databases::sqlite::sqlite (const std::string & name)
{
	//sqlite3_open (name.c_str (), & db);
	connect (name);
}

LIB::containers::databases::sqlite::sqlite (void)
{
	_connected = false;
}
...
const bool LIB::containers::databases::sqlite::connect (const std::string & name)
{
...
const bool LIB::containers::databases::sqlite::disconnect (void)
{
	if (! _connected)
	{
		return true;
...
const bool LIB::containers::databases::sqlite::connected (void) const
{
	return _connected;
}
/*
const sqlite & LIB::containers::databases::operator = (const sqlite & other)
{
	return *this;
}
*/
const bool LIB::containers::databases::operator == (const sqlite & other) const
{
	return this == & other;
}

const bool LIB::containers::databases::sqlite::query (LIB::containers::NAME_A <LIB::containers::NAME_A <LIB::containers::NAME_V, LIB::containers::NAME_V>, LIB::containers::NAME_V> & result, const std::string & qry, const LIB::containers::NAME_A <LIB::containers::NAME_V, LIB::containers::NAME_V> & arguments, const LIB::mathematics::numbers::natural & tries_max)
{
	if (! connected ())
		return false;
...
const bool LIB::containers::databases::sqlite::query (LIB::containers::NAME_A <LIB::containers::NAME_A <LIB::containers::NAME_V, LIB::containers::NAME_V>, LIB::containers::NAME_V> & result, const std::string & qry, const LIB::mathematics::numbers::natural & tries_max)
{
...
const bool LIB::containers::databases::sqlite::query (const std::string & qry, const LIB::containers::NAME_A <LIB::containers::NAME_V, LIB::containers::NAME_V> & arguments, const LIB::mathematics::numbers::natural & tries_max)
{
...
const bool LIB::containers::databases::sqlite::query (const std::string & qry, const LIB::mathematics::numbers::natural & tries_max)
{
	LIB::containers::NAME_A <LIB::containers::NAME_A <LIB::containers::NAME_V, LIB::containers::NAME_V>, LIB::containers::NAME_V> result;
	const LIB::containers::NAME_A <LIB::containers::NAME_V, LIB::containers::NAME_V> arguments;
...
#if defined (SQLITE_CHANGES_SET) && SQLITE_CHANGES_SET
	const bool LIB::containers::databases::sqlite::effect/*_set*/ (const int & val)
	{
...
const LIB::mathematics::numbers::natural LIB::containers::databases::sqlite::effect (void) const
{
