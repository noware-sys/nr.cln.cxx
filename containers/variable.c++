...
namespace LIB
{
	...
	*/
	...
	std::string NAME_V::container::serialize (void) const
	{
		return LIB::serialize <LIB::NAME_V::container> (* this);
	}
	
	bool NAME_V::container::deserialize (const std::string & serial)
	{
		return LIB::deserialize <LIB::NAME_V::container> (serial, * this);
	}
	
	std::string NAME_V::serialize (void) const
	{
		return LIB::serialize <LIB::NAME_V> (* this);
	}
	
	bool NAME_V::deserialize (const std::string & serial)
	{
...
//	}
	...
	mathematics::numbers::natural	NAME_V::length (void) const
	{
		...
		{
			case type::NUMERIC:
				return LIB::tools::digits ((mathematics::numbers::real) value.numeric);
			default:
	...
	*/
	...
	bool	NAME_V::empty (void) const
	{
		return size () <= 0;
	}
	
	std::string NAME_V::substr (const unsigned long long int & beginning, const unsigned long long int & count)
	{
		return (*this).to_string ().substr (beginning, count);
	}
