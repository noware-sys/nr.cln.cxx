...
// gr[oup] [multi]set r[ecursive[_]]array m[ulti[_]]array matrix obj[ect] tree
...
//		};
		...
		class NTT
		{
			...
			public:
				...
				const bool empty (void) const;
				const bool full (void) const;
				const LIB/*::math*/::number::natural size (const bool &/* recursive*/ = false, const bool &/* grouped/inclusive (consider a group as an item, in addition to its children) (only considered if recursive == true)*/ = false) const;
