...
namespace noware
{
	...
	*/	
		...
		*/
		...
		const noware::any operator += (noware::number & other, const noware::any & self)
		{
		...
		const noware::any operator += (long double & other, const noware::any & self)
		{
			...
			//if (tmp.content.t == noware::any::container::type::numeric && tmp.content.number >= noware::math::number (LDBL_MIN) && tmp.content.number <= noware::math::number (LDBL_MAX))
			//	other = tmp;
