			...
			namespace net
			{
				...
				namespace ip
				{
					...
					*/
					...
					//std::string service;
					class mpi : protected noware::net::_mpi // socket //messaging	// interface, mpi
					{
						protected:
						...
						public:
							...
							//const LIB::container::NAME_A <LIB::container::NTT <>, LIB::math::numbers::natural> get_broadcast_multiple (void);
							...
							*/
							...
							// const bool broadcast (const std::string &/* message*/, const LIB::container::NAME_A <LIB::container::NTT <>, math::numbers::natural> &/* addresses */);
...
//							bool receive_async_stop (const boost::function <void (std::string)> &, const bool &/* cycle*/, const unsigned short int & /* port. */, const std::string &/* address*/);
							...
							//void noware::net::mpi::listen_async_internal (void (*/*handler*/) (std::string), const std::string &/*broadcast_address*/, const unsigned short int & /*port*/, const bool &/*cycle*/, unsigned long int /*hash*/ = 0, unsigned long long int/* handler_index*/ = 0);
