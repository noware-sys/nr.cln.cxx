					...
					*/
					...
					class mpi : public LIB::network::_mpi // socket	// messenger, messaging	// interface, mpi
					{
						...
						//public:
							...
							LIB::container::NAME_A <LIB::network::_mpi */*, unsigned short int*/> _connections;
						...
						public:
							...
							// Get the connections.
							const LIB::container::NAME_A <LIB::network::_mpi */*, unsigned short int*/> & connections (void) const;
						protected:
						...
						public:
							...
							const bool receive_async_stop (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> &);
							...
							const bool listen_async_stop (const boost::function <void (const LIB::container::NTT <> &, const std::string &)> &);
