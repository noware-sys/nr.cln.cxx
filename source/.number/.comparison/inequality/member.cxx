...
*/
const bool noware::number::operator != (const cln::cl_N & other) const
{
	return content != other;
}
/*
const bool noware::number::operator != (const cln::cl_R & other) const
{
	return content != other;
}
*/
...
/*
const bool noware::number::operator != (const cln::cl_F & other) const
{
	return content != other;
}
*/
